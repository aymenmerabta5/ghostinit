...
export function databasePackage(
  ...
  runtime?: "node" | "bun",
  features: { auth?: boolean; billing?: boolean; manualBilling?: boolean; posts?: boolean } = {},
): TemplateFile[] {
  ...
  const schemaExports = [
    ...
    ...(features.manualBilling
      ? ['export { manualPayments, manualCreditLedger } from "./manual-payments.js";']
      : []),
