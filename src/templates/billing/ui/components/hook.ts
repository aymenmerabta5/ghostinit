...
import { createBillingCheckoutAction, createBillingPortalAction } from "../actions";
...
export interface BillingInitialData { subscriptions: unknown[]; invoices: unknown[]; licenseKeys: unknown[]; usageEvents: unknown[]; }
...
export function useBillingPage(): UseBillingPageReturn {
  ...
  return { subscriptions, invoices, licenseKey, usageEvents, subsLoading, isCheckoutLoading, pastDue, copyText, handleCheckout, handlePortal };
}
`;
}
