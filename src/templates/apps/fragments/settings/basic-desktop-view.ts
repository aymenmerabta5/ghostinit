import type { DesktopMode } from "../../desktop/model.js";
import { nativeI18nImportPath, nativeI18nTemplate } from "../native-i18n.js";

export function desktopBasicSettingsViewContent(
  hasBilling = true,
  hasEmail = true,
  hasI18n = false,
...
export function BasicSettingsView({ user, isPending, isAuthenticated }: { user?: SettingsUser | null; isPending: boolean; isAuthenticated: boolean }) {
${i18n.hookLine}
${supportingHooks}
