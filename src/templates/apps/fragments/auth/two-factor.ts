  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-background">
      <div className="w-full max-w-[420px] flex flex-col gap-6">
        ${backLink}
        <Card className="shadow-sm"><CardHeader className="gap-3"><div className="flex items-center gap-2"><Badge variant="secondary">2FA</Badge><span className="text-xs text-muted-foreground">TOTP • trust device 30d</span></div><CardTitle className="text-2xl tracking-tight">Two-factor authentication</CardTitle><CardDescription className="max-w-[60ch]">Enter the 6-digit code from your authenticator app. Secure verification with server-side rate limiting and single-use replay protection.</CardDescription></CardHeader>
