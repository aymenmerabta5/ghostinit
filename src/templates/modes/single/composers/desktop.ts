...
export function buildDesktopFiles(
  ...
  return [
    ...
    file("src/renderer/routes/2fa.tsx", desktopRouteTwoFactorContent()),
    file("src/renderer/routes/forgot-password.tsx", desktopRouteForgotPasswordContent()),
    file("src/renderer/routes/reset-password.tsx", desktopRouteResetPasswordContent()),
    file("src/renderer/routes/sign-in.tsx", desktopRouteSignInContent()),
    file("src/renderer/routes/sign-up.tsx", desktopRouteSignUpContent()),
