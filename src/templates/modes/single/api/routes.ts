...
export function singleOrpcRouteContent(): string {
  return [
    ...
    "",
    "  const rpcResult = await rpcHandler.handle(request, matchOptions as any);",
    "  if ((rpcResult as any).matched && (rpcResult as any).response) {",
    "    const response = (rpcResult as any).response as Response;",
    '    response.headers.set("X-Content-Type-Options", "nosniff");',
    '    response.headers.set("Referrer-Policy", "strict-origin-when-cross-origin");',
    "    return response;",
    "  }",
    "",
    "  const openApiResult = await openapiHandler.handle(request, matchOptions as any);",
    "  if ((openApiResult as any).matched && (openApiResult as any).response) {",
    "    const response = (openApiResult as any).response as Response;",
    '    response.headers.set("X-Content-Type-Options", "nosniff");',
    '    response.headers.set("Referrer-Policy", "strict-origin-when-cross-origin");',
    "    return response;",
    "  }",
